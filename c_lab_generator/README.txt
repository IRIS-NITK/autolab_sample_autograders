# About lab
 - Creates a lab which runs students submission and compares its output with that of 'soln.c'
...
# How to use C Lab generator
 ...
 3. Create a file 'soln.c' with expected solution
 ...
 6. execute make by running the 'make' in the c_lab_generator directory, this will create the autograder-Makefile and autograde.tar file
